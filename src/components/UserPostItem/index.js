    ...
    <li key={eachPost.postId} className="post_item_container">
      ...
      <div className="social_div">
        {isLiked ? (
          ...
          >
            <FcLike className="likeIcon" aria-label="likeIcon" />
          </button>
        ) : (
          <button
            onClick={postLikeApi}
            ...
            className="icon_button"
          >
            <BsHeart className="icon" aria-label="likeIcon" />
          </button>
        )}

        <button testid="commentIcon" type="button" className="icon_button">
          <FaRegComment className="icon" aria-label="icon" />
        </button>
        <button testid="shareIcon" type="button" className="icon_button">
          <BiShareAlt className="icon" aria-label="icon" />
        </button>
      </div>
